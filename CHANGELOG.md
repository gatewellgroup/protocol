...
From Annex G of the published text. Each row is a revision of the public comment draft; Version 1.0 becomes final with the disposition table for the comment period.
